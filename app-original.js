//// This file contains the original "broken” version of the Library app. Everything is mixed together here (UI, storage, domain rules, payments, emails), which violates SRP and OCP. I kept this file unchanged so we can clearly compare it to the refactored code.
